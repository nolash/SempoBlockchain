...
if __name__ == '__main__':
    ...
    print('**********************************************************************')
    business_categories = [
        {'name': 'Food', 'icon': 'message', 'translations': {'en': 'Food', 'sw': 'Chakula'}},
        {'name': 'Water', 'icon': 'message', 'translations': {'en': 'Water', 'sw': 'Maji'}},
        {'name': 'Energy', 'icon': 'message', 'translations': {'en': 'Energy', 'sw': 'Kuni/makaa/mafuta/stima'}},
        {'name': 'Education', 'icon': 'message', 'translations': {'en': 'Education', 'sw': 'Elimu'}},
        {'name': 'Health', 'icon': 'message', 'translations': {'en': 'Health', 'sw': 'Afya'}},
        {'name': 'General shop', 'icon': 'message', 'translations': {'en': 'General shop', 'sw': 'Uchuuzi'}},
        {'name': 'Environment', 'icon': 'message', 'translations': {'en': 'Environment', 'sw': 'Mazingira'}},
        {'name': 'Transport', 'icon': 'message', 'translations': {'en': 'Transport', 'sw': 'Usafiri'}},
        {'name': 'Labour', 'icon': 'message', 'translations': {'en': 'Labour', 'sw': 'Mfanyakazi'}},
        {'name': 'Other', 'icon': 'message', 'translations': {'en': 'Other', 'sw': 'Nyingine'}},
    ]
